    ...
    <div class="py-4 min-vh-75 d-flex align-items-center">
        <div class="container">
            ...
            <div class="row mb-4">
                ...
                <p>1. Daftar akun dengan mengklik tombol 'Daftar'.</p>
                <p>2. Login menggunakan email dan kata sandi yang telah Anda daftarkan.</p>
                <p>3. Mulai menjelajahi fitur-fitur yang tersedia di aplikasi.</p>
            </div>
